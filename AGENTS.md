...
- **Before opening a pull request** → run `/pr-self-review`. It reviews the local change set
  against the skills that govern the touched files and blocks `gh pr create|merge` while a
  verified critical finding stands.
