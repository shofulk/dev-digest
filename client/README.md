...
flowchart TD
  ...
  PR -->|"GET /pulls/:id · /reviews · /pulls/:id/comments · /pulls/:id/intent · /pulls/:id/smart-diff<br/>POST /pulls/:id/review · /pulls/:id/intent/derive · /findings/:id/(accept|dismiss)"| API
