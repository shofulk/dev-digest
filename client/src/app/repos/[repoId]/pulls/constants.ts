...
/**
 * Columns whose header and cells are right-aligned (numerics). Keyed by name
 * rather than by index, so inserting a column cannot silently move the
 * alignment onto the wrong one.
 */
